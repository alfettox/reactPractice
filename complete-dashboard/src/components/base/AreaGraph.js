        ...
        <AreaChart data={data} margin={{ top: 10 }}>
          <defs>
            <linearGradient id="colorLy" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#ee0707" stopOpacity={0.8} />
              <stop offset="95%" stopColor="#8f1919" stopOpacity={0} />
            </linearGradient>
            <linearGradient id="colorYtd" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#052190" stopOpacity={0.8} />
              <stop offset="95%" stopColor="#d62710" stopOpacity={0} />
            </linearGradient>
          </defs>
